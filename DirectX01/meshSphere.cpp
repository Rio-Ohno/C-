...
//
//				// メッシュ壁を描画
//				pDevice->DrawIndexedPrimitive(D3DPT_TRIANGLESTRIP, 0, 0, g_Sphere[nCnt].nMaxVtx, 0, g_Sphere[nCnt].nPolyNum);
//			}
//		}
//	}
//	////ライトをつける
...
//
//			g_Sphere[nCnt].nMaxVtx = (g_Sphere[nCnt].DiviX + 1) * (g_Sphere[nCnt].DiviY+1) /*+ 1*/;// 頂点数
//
//			////テクスチャの設定
...
//				g_Sphere[nCnt].nPolyNum = (2 * g_Sphere[nCnt].DiviX * (g_Sphere[nCnt].DiviY) + (g_Sphere[nCnt].DiviY - 1) * 4)-1;					// ポリゴン数
//
//				//インデックスバッファの生成
